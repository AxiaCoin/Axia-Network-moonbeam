...
mod tests {
	use super::*;
	use crate::axiatest::AXIATESTEncoder;
	...
	fn test_as_derivative() {
		...
		let index = <axiatest_runtime::Runtime as frame_system::Config>::PalletInfo::index::<
			axiatest_runtime::Utility,
		>()
		.unwrap() as u8;
		expected_encoded.push(index);

		let mut expected = pallet_utility::Call::<axiatest_runtime::Runtime>::as_derivative {
			index: 1,
			call: axiatest_runtime::Call::Staking(
				pallet_staking::Call::<axiatest_runtime::Runtime>::chill {},
			)
			.into(),
		}
		.encode();
	...
	fn test_stake_bond() {
		...
		let index = <axiatest_runtime::Runtime as frame_system::Config>::PalletInfo::index::<
			axiatest_runtime::Staking,
		>()
		.unwrap() as u8;
		expected_encoded.push(index);

		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::bond {
	...
	fn test_stake_bond_extra() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::bond_extra {
	...
	fn test_stake_unbond() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::unbond {
			value: 100u32.into(),
		}
		.encode();
		expected_encoded.append(&mut expected);
	...
	fn test_stake_withdraw_unbonded() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::withdraw_unbonded {
	...
	fn test_stake_validate() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::validate {
	...
	fn test_stake_nominate() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::nominate {
	...
	fn test_stake_chill() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::chill {}.encode();
		expected_encoded.append(&mut expected);
	...
	fn test_set_payee() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::set_payee {
			payee: pallet_staking::RewardDestination::Controller,
		}
		.encode();
		expected_encoded.append(&mut expected);
	...
	fn test_set_controller() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::set_controller {
			controller: relay_account.clone().into(),
		}
		.encode();
		expected_encoded.append(&mut expected);
	...
	fn test_rebond() {
		...
		let mut expected = pallet_staking::Call::<axiatest_runtime::Runtime>::rebond {
			value: 100u32.into(),
		}
		.encode();
		expected_encoded.append(&mut expected);
