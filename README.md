...
👉 _Reference our [crate-level docs (rustdocs)](https://axia-tech.github.io/moonbeam) to contribute._
...
docker run --network="host" axia-tech/moonbeam:v0.15.1 --chain alphanet
```
...
docker run --network="host" axia-tech/moonbeam:v0.15.1 --dev
```
...
docker run --network="host" axia-tech/moonbeam:v0.15.1 --dev --sealing 6000

# Manually control the block authorship and finality
docker run --network="host" axia-tech/moonbeam:v0.15.1 --dev --sealing manual
```
